...
namespace SeestarWhiska
{
    public class Program
    {
        internal const string DriverID = "SeestarWhiska.Alpaca";
        internal const int DefaultPort = 34567;
        internal const string Manufacturer = "Luis";
        internal const string ServerName = "Local Luis Server";
